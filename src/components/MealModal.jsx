...
const MealModal = ({ meal, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 z-[3000] flex items-center justify-center p-4 md:p-10">
      ...
      <div className="relative w-full max-w-5xl bg-surface border border-border rounded-[2.5rem] overflow-hidden max-h-[90vh] flex flex-col md:flex-row animate-in zoom-in-95 duration-500 shadow-2xl">
        {/* Close Button */}
        <button 
          onClick={onClose}
            ...
            <section>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                {ingredients.map((ing, i) => (
                  <div key={i} className="flex items-center gap-3 p-3 bg-surface-hover border border-border rounded-xl">
